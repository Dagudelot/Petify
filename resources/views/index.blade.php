...
@section('content')
							...
							<div class="main-container">
								<div class="container">
									...
									<div class="image-wrapper wow fadeInUp animated" data-wow-delay="0.75s">
										<img src="{{ voyager::image(setting('site.mainimage')) }}" alt="">
									</div>

									<h1 class="wow fadeInUp animated">{{ setting('site.mainlabel') }}</h1>
				...
				<div class="app">
					...
					<div class="interfaz">
						<div class="phone-mockup"><img src="{{ asset('images/home/mobile-mockup.png') }}"></div>
						<div class="slider-row">
							<div class="screenshoot-slider">
								<div class="item"><img src="{{ asset('images/home/apps-1.jpg') }}"></div>
								<div class="item"><img src="{{ asset('images/home/apps-2.jpg') }}"></div>
								<div class="item"><img src="{{ asset('images/home/apps-3.jpg') }}"></div>
								<div class="item"><img src="{{ asset('images/home/apps-1.jpg') }}"></div>
								<div class="item"><img src="{{ asset('images/home/apps-1.jpg') }}"></div>
							</div> 
						</div> 
					...
					<div class="row">
						<div class="col-lg-3 col-md-4 col-xs-6">
							<div class="single-blog">
								...
								<div class="text">
									<h6>Carlos French.</h6>
									<h5><a href="{{ route('blog') }}" class="tran3s">Cómo hacer un delicioso almuerzo para tu gato</a></h5>
						...
						<div class="col-lg-3 col-md-4 col-xs-6">
							<div class="single-blog">
								...
								<div class="text">
									<h6>María Zapata.</h6>
									<h5><a href={{ route('blog') }}l" class="tran3s">Cuidados para tu perro en el parque</a></h5>
									<p>Their testimonial videos aren't production quality, but they get message across, cover useful & relevant information with tips.</p>
								</div>
							</div> 
						</div>
						<div class="col-lg-3 col-md-4 col-xs-6">
							<div class="single-blog">
								...
								<div class="text">
									...
									<h5><a href="{{ route('blog') }}" class="tran3s">Cómo limpiar tu gato adecuadamente</a></h5>
									<p>Their testimonial videos aren't production quality, but they get message across, cover useful & relevant information with tips.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-4 col-xs-6">
							<div class="single-blog">
								...
								<div class="text">
									...
									<h5><a href="{{ route('blog') }}" class="tran3s">Cómo hacer una cama para tu mascota</a></h5>
									<p>Their testimonial videos aren't production quality, but they get message across, cover useful & relevant information with tips.</p>
								</div>
							</div> 
						</div>
